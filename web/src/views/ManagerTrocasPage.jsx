            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-slate-400">
                        Pedidos em que o colega já aceitou — falta a sua decisão para atualizar a escala. Aprovar substitui o plantonista
                        locado pelo médico solicitante nesse turno.
                    </p>
                </div>
                {units.length > 0 ? (
                    ...
                    <table className="min-w-[720px] w-full text-left">
                        <thead>
                            <tr className="border-b border-slate-800 bg-slate-900 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                                ...
                                <th className="px-5 py-4">Colega (plantão)</th>
                            ...
                            {pedidos.map((p) => {
                                ...
                                return (
                                    <tr key={p.id} className="transition-colors hover:bg-slate-800/20">
                                        ...
                                        <td className="px-5 py-4 text-sm text-slate-300">{alvo}</td>
